...
##
# I started this one with a big nested case statement and quickly gave up as
# that became untenable and switched to this search implementation after
# thinking of the water flowing like a tree and having a tree with all the
# used water spots.
#
# I ended up noticing I could record the water in a Hash and that was good
# enough.
#
# Figuring out how to get "flow" water to flow left and right after filling up
# a basin took some work.  I had lots of times where the water flowed out in
# multiple paths or entered exponential loops of trying to flow on top of
# itself.
#
# The final gotcha was that the water starts being used after it is on the
# same level as the first bit of clay 🙄.  I spent 15 minutes trying to figure
# out that one before seeing somebody else point it out on reddit.
